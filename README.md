> [!NOTE]
> If FLTK is not your thing, there is a [GTK version of SpiritVNC](https://github.com/willbprog127/spiritvnc-gtk)
...
While I'm not a big fan of how the GNOME and GTK projects are being run, [there is a GTK version available](https://github.com/willbprog127/spiritvnc-gtk) if FLTK isn't your thing.

#### Why not Qt?
Qt licensing has always been perplexing to me, so I'd rather not invest a whole bunch of work into a Qt version only to be sued by them for some weird reason.
...
#### Will you release pre-compiled executables?
I would like to, but don't have the time right now. It would be necessary to keep a constant eye on when each dependency is updated and that takes more free time than I currently have. If anyone knows of some automated solution to this, please create an Issue.
